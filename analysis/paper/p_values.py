...
def main():
    ...
    df_hexapod_suppl_obs = pd.read_csv("/Users/looka/git/sferes2/exp/aurora/analysis/paper/p_02_analysis_learned_behavioural_space/data_obs_hexapod/df_hexapod_camera_vertical_processed.csv")
    ...
    df_hexapod_suppl_obs = df_hexapod_suppl_obs[df_hexapod_suppl_obs["name_variant"].isin(list_algorithms_hexa_diversity)]
