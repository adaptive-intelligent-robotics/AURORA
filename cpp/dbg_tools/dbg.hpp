...
#ifndef DBG_AIRL_DBG_H
#define DBG_AIRL_DBG_H
...
/*
     ...
     * @see dbg::source_pos
 */
#define AIRL_DBG_HERE (::airl::dbg::source_pos(__LINE__, DBG_FUNCTION, __FILE__, DBG_SOURCE))
    ...
    struct assert_info : public source_pos
    {
      ...
      assert_info(bool a, const char* t, line_no_t line, func_name_t func, file_name_t file, dbg_source spos)
        : source_pos(line, func, file, spos)
        , asserted(a)
        , text(t)
      {}
...
/*
     ...
     * @see dbg::assertion
 */
#define AIRL_DBG_ASSERTION(a) ::airl::dbg::assert_info(a, DBG_STRING(a), AIRL_DBG_HERE)
     ...
     */
    inline void
    assertion(level lvl, const assert_info& ai)
    {
      assertion(lvl, 0, ai);
    }
     ...
     */
    inline void
    assertion(dbg_source src, const assert_info& ai)
    {
     ...
     */
    inline void
    assertion(const assert_info& ai)
    {
     ...
     */
    inline void
    sentinel(level lvl, const source_pos& here)
    {
      sentinel(lvl, 0, here);
    }
     ...
     */
    inline void
    sentinel(dbg_source src, const source_pos& here)
    {
     ...
     */
    inline void
    sentinel(const source_pos& here)
    {
     ...
     */
    inline void
    unimplemented(level lvl, const source_pos& here)
    {
     ...
     */
    inline void
    unimplemented(dbg_source src, const source_pos& here)
    {
     ...
     */
    inline void
    unimplemented(const source_pos& here)
    {
     ...
     */
    inline void
    check_ptr(level lvl, const void* p, const source_pos& here)
    {
     ...
     */
    inline void
    check_ptr(dbg_source src, const void* p, const source_pos& here)
    {
     ...
     */
    inline void
    check_ptr(const void* p, const source_pos& here)
    {
     ...
     */
    inline void
    check_bounds(level lvl, dbg_source src, int index, int minbound, int maxbound, const source_pos& here)
    {
    ...
    template<class T>
    void
    check_bounds(level lvl, dbg_source src, int index, T& array, const source_pos& here)
    {
    ...
    template<class T>
    void
    check_bounds(level lvl, int index, T& array, const source_pos& here)
    {
    ...
    template<class T>
    void
    check_bounds(dbg_source src, int index, T& array, const source_pos& here)
    {
    ...
    template<class T>
    void
    check_bounds(int index, T& array, const source_pos& here)
    {
    ...
    public:
      ...
      ~post_mem_fun()
      {
        assertion(
          m_lvl,
          m_src,
          assert_info((m_obj->*m_fn)(), "post condition", m_pos.line, m_pos.func, m_pos.file, m_pos.src));
      }
    ...
    public:
      ...
      {
        assertion(
          m_lvl, m_src, assert_info(m_fn(), "post condition", m_pos.line, m_pos.func, m_pos.file, m_pos.src));
      }
...
#define AIRL_DBG_HERE ((void*)0)
#define AIRL_DBG_ASSERTION(a) ((void*)0)
   ...
   * @internal
    ...
    {}
    inline void
    enable(level, dbg_source, bool)
    {}
    inline void
    enable_all(level, bool)
    {}
    inline null_stream out(level, dbg_source) { return null_stream(); }
    inline null_stream out(level) { return null_stream(); }
    inline void
    attach_ostream(level, std::ostream&)
    {}
    inline void
    attach_ostream(level, dbg_source, std::ostream&)
    {}
    inline void
    detach_ostream(level, std::ostream&)
    {}
    inline void
    detach_ostream(level, dbg_source, std::ostream&)
    {}
    ...
    inline void
    set_prefix(const char*)
    {}
    inline void
    enable_level_prefix(bool)
    {}
    inline void
    enable_time_prefix(bool)
    {}

    inline void set_assertion_behaviour(level, assertion_behaviour) {}
    inline void set_assertion_period(dbgclock_t) {}
    inline void
    assertion(level, dbg_source, void*)
    {}
    inline void
    assertion(level, void*)
    {}
    inline void
    assertion(dbg_source, void*)
    {}
    inline void
    assertion(void*)
    {}
    inline void
    sentinel(level, dbg_source, void*)
    {}
    inline void
    sentinel(level, void*)
    {}
    inline void
    sentinel(dbg_source, void*)
    {}
    inline void
    sentinel(void*)
    {}
    inline void
    unimplemented(level, dbg_source, void*)
    {}
    inline void
    unimplemented(level, void*)
    {}
    inline void
    unimplemented(dbg_source, void*)
    {}
    inline void
    unimplemented(void*)
    {}
    inline void
    check_ptr(level, dbg_source, const void*, void*)
    {}
    inline void
    check_ptr(level, const void*, void*)
    {}
    inline void
    check_ptr(dbg_source, const void*, void*)
    {}
    inline void
    check_ptr(const void*, void*)
    {}
    inline void
    check_bounds(level, void*, int, int, void*)
    {}
    inline void
    check_bounds(level, dbg_source, int, void*, void*)
    {}
    inline void
    check_bounds(level, dbg_source, int, int, void*, void*)
    {}
    inline void
    check_bounds(level, int, void*, void*)
    {}
    inline void
    check_bounds(void*, int, void*, void*)
    {}
    inline void
    check_bounds(int, void*, void*)
    {}
