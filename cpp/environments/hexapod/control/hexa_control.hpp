...
#include "environments/hexapod/control/hexapod_controller_simple.hpp"
...
namespace robot_dart {
  namespace control {
    ...
    public:
      ...
      Eigen::VectorXd
      query(const std::shared_ptr<robot_dart::Robot>& robot, double t)
      {
        if (!_h_params_set) {
      ...
      void
      set_h_params(const Eigen::VectorXd& h_params)
      {
        _dt = h_params[0];
        _h_params_set = true;
      }
